            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>缩略图：</th>
                        <td>
                            <input type="text" width="50px" class="lg" name="art_thumb">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img style="max-width:350px;max-height:100px" class="art_thumb_img" src="">
                    ...
                    <tr>
                        <th>文章内容：</th>
                        <td>
                            <script name="art_content" id="editor" type="text/plain" style="width:860px;height:500px;"></script>
                            <script type="text/javascript">
