...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/navs/').'/'.$old->nav_id}}" method="post">
        {{method_field('PUT')}}
        {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                     <tr>
                        <th style="width:120px;"><i class="require">*</i>导航名称：</th>
                        <td>
                            <input type="text" name="nav_name" value="{{$old->nav_name}}">
                            <input type="text" class="sm" name="nav_alias" value="{{$old->nav_alias}}">
                        </td>
                    </tr>
                     ...
                     <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="lg" name="nav_order" value="{{$old->nav_order}}">
                        </td>
                    </tr>
