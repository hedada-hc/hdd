	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/links/create')}}"><i class="fa fa-plus"></i>添加导航</a>
                    <a href="{{url('admin/links')}}"><i class="fa fa-recycle"></i>全部导航</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
            ...
            <table class="add_tab">
                <tbody>
                     ...
                     <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="lg" name="nav_order" value="1">
                        </td>
                    </tr>
